...
public class VectorizedStringDecoder {
  ...
  public static Vector decodeToRandomAccessFormat(
      String name, byte[] data, IntWrapper offset, int numStreams, BitVector bitVector, int numFeatures) {
    ...
    if (symbolTableStream != null) {
      ...
      return bitVector != null?
              StringDictionaryVector.createNullableVector(name, bitVector, offsetStream, dictionaryLengthStream,
                      dictionaryStream) :
              StringDictionaryVector.createNonNullableVector(name, offsetStream, dictionaryLengthStream,
                      dictionaryStream, numFeatures);
    }

    return bitVector != null? StringFlatVector.createNonNullableVector(name, bitVector, offsetStream, dictionaryStream):
            StringFlatVector.createNonNullableVector(name, offsetStream, dictionaryStream, numFeatures);
  }
